...
\subsection{Registers and Stack}\label{sec:stack}
...
\subsubsection{NOOP}
\subsubsection{HALT}
\subsubsection{DEBUGI}
\subsubsection{DEBUGR}
\subsubsection{MOV}
\subsubsection{PUSH}
\subsubsection{POP}
\subsubsection{CALL}
\subsubsection{RETURN}
\subsubsection{ARGS\_LOCALS}
\subsubsection{CLEAR}
\subsubsection{TRUE}
\subsubsection{LOAD\_INT}
\subsubsection{LOAD\_FLOAT}
\subsubsection{TYPE}
\subsubsection{LOGICAL\_AND}
\subsubsection{LOGICAL\_OR}
...
\subsubsection{MOD}
\subsubsection{JUMP}
\subsubsection{JUMP\_IF}
\subsubsection{JUMP\_EQ}
\subsubsection{JUMP\_NE}
\subsubsection{JUMP\_LE}
\subsubsection{JUMP\_LT}
